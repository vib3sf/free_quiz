...
urlpatterns = [
    ...
    path('poll/<int:question_id>/edit_question', EditQuestion.as_view(), name='edit_question'),
    path('poll/<int:question_id>/delete_question/', DeleteQuestion.as_view(), name='delete_question'),
    ...
    path('poll/<int:choice_id>/pick', pick, name='pick'),
    path('poll/<int:poll_id>/vote', CreateOrEditVote.as_view(), name='vote'),
    path('poll/<int:poll_id>/finish', finish_poll, name='finish')
]
